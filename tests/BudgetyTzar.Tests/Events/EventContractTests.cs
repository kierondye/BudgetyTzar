...
public sealed class EventContractTests
{
    ...
    public async Task RealOutboxEnvelopesValidateAgainstDomainContractSchemas()
    {
        ...
        await BudgetApiTestClient.RecordAdjustment(client, budget.Id, salary.Id, 20m, BudgetAdjustmentType.Credit, new DateOnly(2026, 6, 12));
        await BudgetApiTestClient.RecordAdjustment(client, budget.Id, groceries.Id, 20m, BudgetAdjustmentType.Debit, new DateOnly(2026, 6, 12));
