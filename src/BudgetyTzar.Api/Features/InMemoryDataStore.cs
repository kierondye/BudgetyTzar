...
public sealed class InMemoryDataStore
{
    ...
    internal Dictionary<OwnedBudgetName, Guid> BudgetIdsByOwnerAndName { get; } = [];
...
internal sealed record OwnedBudgetName(ApplicationUserId OwnerId, NormalizedName Name);
